...
```bash
git remote add encore encore://coolie-movie-countdown-na32
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/coolie-movie-countdown-na32/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/coolie-movie-countdown-na32/settings/integrations/github)
